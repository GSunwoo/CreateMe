...
import com.admin.mapper.IAdminConfirmMapper;
import com.common.dto.PageDTO;
import com.common.dto.ParameterDTO;
import com.member.dto.FarmDTO;
...
public class AdminController {
	...
	public String adminMypage(Model model, ParameterDTO parameterDTO, HttpServletRequest req) {
	...
	public String adminReviewDelete(@RequestParam("review_id") Long review_id) {
		
		reviewDAO.deleteReivew(review_id);
