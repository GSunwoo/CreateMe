package com.farm.product.prod_img.mapper;
...
@Mapper
public interface IProductImgMapper {
	...
	public String selectFilename(@Param("prod_id") Long prod_id, @Param("idx") Long idx);
	public List<String> selectAllFilenames(@Param("prod_id") Long prod_id);
