...
.board-white-table input[type="text"], .board-white-table textarea {
	width: 90%;
	padding: 8px;
	...
	<div class="mypage-wrapper">
		<div class="mypage-container">
			...
			<div class="mypage-content">
				...
				<form
					action="${pageContext.request.contextPath}/buyer/inquiryUpdate.do"
					method="post">
					<!-- 컨트롤러에서 요구하는 파라미터 -->
					<input type="hidden" name="prod_id" value="${inquiryDTO.prod_id}">
					<input type="hidden" name="inquiry_id"
						value="${inquiryDTO.inquiry_id}" /> <input type="hidden"
						name="member_id" value="${inquiryDTO.member_id}" />
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" name="title"
										value="${inquiryDTO.title}" placeholder="제목을 입력하세요"
										style="width: 60%;" maxlength="200" required></td>
								</tr>
								<tr>
									<th scope="row">본문</th>
									<td><textarea name="content" rows="10" style="width: 90%;"
											placeholder="내용을 입력하세요" required>${inquiryDTO.content}</textarea>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="btn-center-box">
						<button type="button" class="btn-before" onclick="history.back();">
							<strong>이전</strong>
						</button>
						<button type="submit" class="btn-write-ok">
							<strong>수정 저장</strong>
						</button>
					</div>
				</form>
