...
<div class="mypage-wrapper">
  ...
  <div class="modal" id="modalAddr" aria-hidden="true">
    <div class="panel" role="dialog" aria-modal="true">
      ...
      <div class="panel-bd" hidden="hidden">
        <div class="row" hidden="hidden">
          <input class="input-lg" id="m_zip"  name="zipcode" placeholder="우편번호" style="max-width:140px"
                 value="<c:out value='${zipcode}'/>" readonly hidden="hidden">
          <button hidden="hidden" class="btn-sm ghost" id="btnPost" type="button">우편번호 찾기</button>
        </div>
        <input class="input-lg" id="m_addr1" name="addr1" placeholder="기본주소" value="<c:out value='${addr1}'/>" readonly hidden="hidden">
        <input class="input-lg" id="m_addr2" name="addr2" placeholder="상세주소" value="<c:out value='${addr2}'/>" hidden="hidden">
      </div>
